            ...
            <div class="right__tableWrapper">
                ...
                <table>
                    ...
                    <tbody id="tktime">
                        ...
                        $sql = "SELECT sp.masp,sp.tensp,Sum(cthd.soluong) as soluong,sp.linkhinhanh,sp.giaban,tbl_hoadon.trangthai from tbl_sanpham as sp,tbl_chitiethd as cthd, tbl_hoadon where sp.masp=cthd.masp and tbl_hoadon.trangthai='Hoàn thành' and cthd.mahd = tbl_hoadon.mahd and sp.matheloai = $ma group by sp.masp order by soluong DESC";
                        $query = $connect->query($sql);
                        while ($row = $query->fetch_array()) {
